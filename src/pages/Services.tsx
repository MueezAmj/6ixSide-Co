      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Delivery Coverage Area</h2>
            <div className="bg-white rounded-lg shadow-md p-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">Same-Day Delivery Available</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">Next-Day Delivery Available</h3>
                  <ul className="space-y-2 text-gray-600">
                    <li>• Markham</li>
                    <li>• Richmond Hill</li>
                    <li>• Vaughan</li>
      ...
      <section className="bg-yellow-500 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="/quote" 
              className="bg-black text-yellow-500 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-800 transition-colors"
            >
              Request a Quote
            </a>
            <a 
