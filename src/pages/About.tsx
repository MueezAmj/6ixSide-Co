        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Only the highest quality materials from trusted manufacturers</p>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Knowledgeable team ready to help with your project needs</p>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Quick turnaround times and reliable delivery across the GTA</p>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Deep understanding of GTA construction needs and regulations</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-yellow-50 p-8 rounded-lg mb-16">
              <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">Our Service Area</h3>
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  <h4 className="font-semibold text-lg mb-2">Toronto Proper</h4>
                  <p className="text-gray-600 text-sm">Downtown, North York, Scarborough, Etobicoke, East York, York</p>
                </div>
                <div>
                  <h4 className="font-semibold text-lg mb-2">Greater Toronto Area</h4>
                  <p className="text-gray-600 text-sm">Mississauga, Brampton, Markham, Richmond Hill, Vaughan, Oakville</p>
                </div>
                <div>
                  <h4 className="font-semibold text-lg mb-2">Surrounding Areas</h4>
                  <p className="text-gray-600 text-sm">Ajax, Pickering, Whitby, Oshawa, Burlington, Milton</p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <h3 className="text-3xl font-bold text-gray-800 mb-6">Our Commitment</h3>
